...
ActiveRecord::Schema[7.1].define(version: 2024_01_21_104547) do
  create_table "jobs", primary_key: "job_id", id: :string, force: :cascade do |t|
    ...
    t.index ["priority", "scheduled_at", "enqueued_at"], name: "index_jobs_on_priority_and_scheduled_at_and_enqueued_at"
